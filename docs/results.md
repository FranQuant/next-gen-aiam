...
mechanisms. Stacking them (applying VMP to v2a) yields Sharpe=1.608 and Calmar=0.921,
...
partial substitutes. Stacking both yields the best combined Sharpe in the study (1.608
...
- **JNJ** — Johnson & Johnson
- **JPM** — US large-cap financials equity (ticker)
- **MSFT** — Microsoft Corp.
- **NVDA** — NVIDIA Corp.
