...
We evaluate 62 portfolio strategies on a single 29-asset multi-asset universe spanning six
asset classes (US and international equities, fixed income, real assets, commodities, and
alternative risk premia) over 2003–2026 (23.3 years, approximately 5,870 NYSE trading days).
The 62 strategies comprise 24 base families — covering classical mean-variance
\citep{markowitz1952portfolio}, diversification objectives
\citep{choueifaty2008toward,maillard2010properties}, hierarchical risk parity
...
and Fama-French factor tilts \citep{fama1993common} — together with their 31 volatility-managed
counterparts \citep{moreira2017volatility} and seven expanded estimator variants. All strategies
share a common walk-forward harness, a single held-out test period (2023 onwards), identical
transaction-cost accounting, and a Sharpe ratio convention following \citet{sharpe1966mutual}.
Statistical robustness is assessed via \citet{memmel2003performance} paired tests,
block-bootstrap confidence intervals, and calendar-year sub-period analysis.
...
entirely from training data through a Hidden Markov Model with eight macro indicators,
...
The uncomfortable footnote deserves its own paragraph. Cross-strategy variation in calendar-year
Sharpe ratios exceeds the differences in the full-period headline table for most pairs. A
...
regime detectors (Paper 2) and to an agentic research workflow that integrates LLM-generated views
into the Black-Litterman framework (Paper 3).
